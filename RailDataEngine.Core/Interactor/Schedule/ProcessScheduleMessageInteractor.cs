...
{
    public class ProcessScheduleMessageInteractor : IProcessScheduleMessageInteractor
    {
        ...
        public ProcessScheduleMessageInteractor(IScheduleMessageDeserializationService messageDeserializationService, IScheduleMessageConversionService messageConversionService, IScheduleMessageStorageService messageStorageService)
        {
        ...
        public void ProcessScheduleMessages(ProcessScheduleMessageInteractorRequest request)
        {
