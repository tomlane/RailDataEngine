...
namespace RailDataEngine.Domain.Deserializers.TrainMovements.Entity.Json
{
    public class DeserializedJsonTrainCancellation : DeserilaizedTrainMovementMessage
    {
        [JsonProperty("header")]
