...
namespace RailDataEngine.Gateway.EF.Tests.Schedule
{
    ...
    class TLocationGateway
    {
        ...
        public void throws_when_dependencies_are_null()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new LocationGateway(null));
        }
        ...
        public void can_be_built_from_static_container()
        {
            ...
            var gateway = container.Resolve<IStorageGateway<LocationEntity>>();
            Assert.IsInstanceOf<LocationGateway>(gateway);
        }
    }
}
